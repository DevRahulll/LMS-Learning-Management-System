            ...
            <div className="flex flex-col gap-10 items-center justify-center min-h-[90vh] py-10 text-white mx-5">
                ...
                {(lectures && lectures.length > 0) ?
                    (<div className="flex justify-center gap-10 w-full ">
                        {/* left section for playing videos and displaying course to admin*/}
                        <div className="space-y-5 w-[28rems] p-2 rounded-lg shadow-[0_0_10px_black]">
                            ...
                            <div>
                                ...
                                <p>
                                    <span className='text-yellow-500 lin-clamp-4'>
                                        Description: {" "}
                                    </span>
                            ...
                            <li className='font-semibold text-xl text-yellow-500 flex items-center justify-between'>
                                ...
                                {role === 'ADMIN' && (
                                    <button
                                        ...
                                        className='btn-primary px-2 py-1 border-white rounded-md font-semibold text-sm'>
                                        Add New Lecture
                                    </button>
                                )}
                            </li>
